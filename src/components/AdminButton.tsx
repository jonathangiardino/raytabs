...
export default function AdminButton({
  ...
  return isAdmin ? (
    <button
      ...
      className="ml-auto flex gap-1 items-center bg-[var(--admin-label-bg)] md:hover:opacity-80 text-[11px] text-[var(--admin-label-text)] px-2 py-1 rounded-[2px] button-focus"
    >
