  ...
  return isAdmin ? (
    ...
    <>
      <button
        tabIndex={-1}
        onClick={handleCheckboxChange}
        className="flex gap-1 md:hidden group-focus-visible:hidden md:group-hover:flex items-center ml-auto bg-[var(--admin-set-btn)] md:hover:opacity-80 text-[11px] px-2 py-1 rounded-[2px] animate-fade-in"
      >
